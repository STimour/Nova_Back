        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                logger_1.default.error(
                    'Error in UserService.findAllUsers: %s',
    ...
    getAllHelpers() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                logger_1.default.error(
                    'Error in UserService.getAllHelpers: %s',
                    (0, errorHandler_middlewares_1.getErrorMessage)(error)
                );
                throw error;
            }
    ...
    findHelper(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                logger_1.default.error(
                    'Error in UserService.findHelper: %s',
                    (0, errorHandler_middlewares_1.getErrorMessage)(error)
                );
                throw error;
            }
    ...
    findAllStudents() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                logger_1.default.error(
                    'Error in UserService.findAllStudents: %s',
                    (0, errorHandler_middlewares_1.getErrorMessage)(error)
                );
                throw error;
            }
    ...
    findStudent(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                logger_1.default.error(
                    'Error in UserService.findStudent: %s',
                    (0, errorHandler_middlewares_1.getErrorMessage)(error)
                );
                throw error;
            }
    ...
    createUser(userData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const isUserExists = yield this._userRepository.isUserExists(
                    userData.email,
                    userData.firstname
                );
                if (isUserExists) {
